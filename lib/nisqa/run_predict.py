...
parser.add_argument('--input_scp', type=str, help='scp file with speech files')
...
elif args['mode'] == 'predict_scp':
    if args['input_scp'] is None:
        raise ValueError('--input_scp argument with scp file needed')
