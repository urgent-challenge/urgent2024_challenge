...
❗️❗️**[2025-05-16]** The official evaluation datasets (validation, non-blind test, and blind test) have been uploaded to HuggingFace. You can find them at [https://huggingface.co/datasets/urgent-challenge/urgent2024_official](https://huggingface.co/datasets/urgent-challenge/urgent2024_official). An additional speech quality assessment dataset with human-annotated mean opinion score (MOS) labels has also been released at [https://huggingface.co/datasets/urgent-challenge/urgent2024_mos](https://huggingface.co/datasets/urgent-challenge/urgent2024_mos).
